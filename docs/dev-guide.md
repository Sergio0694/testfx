...
To build and test all functionalities of MSTest, we recommend installing [Visual Studio 2022 17.13 or higher](https://visualstudio.microsoft.com/) with the following workloads:
